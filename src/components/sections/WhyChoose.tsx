                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      border: activeIndex === i ? "1.5px solid rgba(11, 29, 51, 0.25)" : "1px solid rgba(11, 29, 51, 0.1)",
                      backdropFilter: "blur(10px)",
                      boxShadow: activeIndex === i ? "0 4px 16px rgba(11, 29, 51, 0.08)" : "none",
                      color: "#000000",
                      display: "flex",
                      alignItems: "center",
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      boxShadow: "0 4px 12px rgba(11, 29, 51, 0.05)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}>
